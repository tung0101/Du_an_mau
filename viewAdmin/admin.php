    ...
    <main>
        ...
        <?php
            ...
            echo '
                        ...
                        <td class="an"></td>
                        <td class="an"></td>
                        <td class="them" colspan="2"> <a href="../controller/indexAdmin.php?act=themuser"><i class="fa-solid fa-circle-plus"></i>Thêm</a> </td>
                        </tr>
                    ';
            echo '
                    <tr>
            ...
            echo '
                    ...
                    <tr>
                        ...
                        <td class="ad"><a onclick="return Deluser()" href="'.$dellink.'"> <i class="fa-solid fa-trash"></i> </a></td>
                    </tr>
                    ';
