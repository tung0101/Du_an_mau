                ...
                foreach($query as $row) {
                    ...
                    echo '
                                    <tr>
                                        ...
                                        <td class="ad"><a href="../model/suasp.php?page_layout=sua&id=' . $row['id'] . '"> <i class="fa-solid fa-pen"></i> </a></td>
                                        <td class="ad"><a href="../model/xoasp.php?page_layout=xoa&id=' . $row['id'] . '"> <i class="fa-solid fa-trash"></i> </a></td>
                                    </tr>
                                    ';
                    echo "</table>";
                }
